// --- Portfolio content -----------------------------------------------------
// Single source of truth for the page. Matches the published design canvas.
...
export const profile = {
  ...
  available: true,
  // English CV for now; a Spanish version (CV_Nicolas_Hermida.pdf) ships with
  // the localized site later.
